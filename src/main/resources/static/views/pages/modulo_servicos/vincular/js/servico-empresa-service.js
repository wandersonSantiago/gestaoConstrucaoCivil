app.factory('servicoEmpresaService', function($rootScope, toastr, $http,$q){
	...
	return{
		...
		buscarServicosDaPrestadora: function(id){
			return $http.get('/rest/servico/vincular/prestadora/'+id+'/pagamentos/')
			.then(function(response){
				return response.data;
			},function(errResponse){
				sweetAlert({ timer : 30000,  text : errResponse.data.message , type : "info", width: 300, higth: 100, padding: 20});
		...
		buscarServicosDaPrestadoraPorId: function(id){
			return $http.get('/rest/servico/vincular/buscarPorId/' +id)
			.then(function(response){
				return response.data;
			},function(errResponse){
				sweetAlert({ timer : 30000,  text : errResponse.data.message , type : "info", width: 300, higth: 100, padding: 20});
