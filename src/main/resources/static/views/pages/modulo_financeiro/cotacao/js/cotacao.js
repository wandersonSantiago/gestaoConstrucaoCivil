app.config(function($stateProvider, $urlRouterProvider) {
	...
	$stateProvider
		.state('cotacao', {
			url : '/cotacao',
			templateUrl : 'views/pages/modulo_financeiro/cotacao/cotacao.index.html',
		...
		.state('cotacao.consultar', {
			url : "/consultar",
			templateUrl : "views/pages/modulo_financeiro/cotacao/cotacao.list.html",
		...
		.state('cotacao.cadastrar', {
			...
			url : "/cadastrar",
			templateUrl : "views/pages/modulo_financeiro/cotacao/cotacao.form.html",
		...
		.state('cotacao.editar-empresa', {
			...
			templateUrl : "views/pages/modulo_financeiro/cotacao/cotacao.lancar.html",
		...
		.state('cotacao.lancar', {
			...
			.state('cotacao.show', {
				requiresAuthentication: true,
				url : "/:idCotacao/show",
				templateUrl : "views/pages/modulo_financeiro/cotacao/cotacao.show.html",
		...
		.state('cotacao.menu', {
			requiresAuthentication: true,
			url : "/menu",
			templateUrl : "views/pages/modulo_financeiro/cotacao/home.html",
			ncyBreadcrumb: {
				 	parent: 'fincanceiro',
				    label: 'Cotacao'
				  }
