...
import br.com.app.entity.ConfigEmpreendimento;
import br.com.app.repository.ConfigEmpreendimentoRepository;
...
public class ConfigEmpreendimentoService {
    ...
    public Optional<ConfigEmpreendimento> buscarPorId(Long id)
    {
        return configEmpreendimentoRepository.findById(id);
    }
