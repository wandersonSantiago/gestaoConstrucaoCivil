...
import br.com.app.servico.domain.model.Imagens;
import br.com.app.servico.domain.model.OcorrenciaServico;
import br.com.app.servico.domain.model.ServicoEmpresa;
import br.com.app.servico.domain.service.ServicoEmpresaService;

@RestController
@RequestMapping("/rest/servicos/vincular")
public class ServicoEmpresaResource {
