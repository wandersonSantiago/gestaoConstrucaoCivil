...
import br.com.app.financeiro.domain.enuns.TipoNotaEnum;
import br.com.app.financeiro.domain.model.NotaFiscalProduto;
import br.com.app.financeiro.domain.service.NotaFiscalProdutoService;

@RestController
@RequestMapping("/rest/nota-fiscal-produto")
public class NotaFiscalProtudoResource {
