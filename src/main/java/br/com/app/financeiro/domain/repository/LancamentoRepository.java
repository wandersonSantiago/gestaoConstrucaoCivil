...
public interface LancamentoRepository extends JpaRepository<Lancamento, Long>, JpaSpecificationExecutor<Lancamento> {
	...
	BigDecimal somaSaldoDataInicioEDataFinalNaoPagoOuNaoRecebido(TipoLancamentoEnum tipo, Date dataInicial,
			Date dataFinal, Long idEmpreendimento);
	...
	List<Lancamento> findByEmpreendimento_idAndDataPagamentoOuRecebimentoIsNullAndDataVencimentoBefore(
			Long idEmpreendimento, Date hoje);
