...
import br.com.app.estoque.domain.repository.RequisicaoRepository;
...
public class RequisicaoService {
	...
	public Page<Requisicao> findByCodigo(String tipo,String descricao, Pageable page) {
		...
		if(tipo.equalsIgnoreCase("MINHA_REQUISICAO")) {
			requisicao = requisicaoRepository.findByNumeroRequisicaoAndEmpreendimentoIdAndIdUsuario(Integer.valueOf(descricao),
					usuario.getEmpreendimento().getId(), usuario.getId(), page);
		}else {
			requisicao = requisicaoRepository.findByNumeroRequisicaoAndEmpreendimentoId(Integer.valueOf(descricao),
