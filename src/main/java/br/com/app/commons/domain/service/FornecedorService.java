...
import br.com.app.commons.domain.repository.FornecedorRepository;
...
public class FornecedorService {
	...
	public Page<Fornecedor> findByDescricaoIgnoreCase(String descricao, Pageable page) {
		...
		if (descricao.matches("[0-9]+")) {
			...
			list = fornecedorRepository.findByDadoEmpresaRazaoSocialIgnoreCaseContaining(descricao, page);
		}
