...
public class PedidoCompraRestController {
	...
	public ResponseEntity<PedidoCompra> salva(@RequestBody PedidoCompra pedidoCompra){
	...
	public ResponseEntity<Collection<PedidoCompra>> lista(){
	...
	public ResponseEntity<PedidoCompra> buscarCotacaoPorId(@PathVariable Long id) {
