...
public class ChamadoManutencaoRestController {
	...
	public ResponseEntity<ChamadoManutencao> salvar(@RequestBody ChamadoManutencao chamadoManutencao,
	...
	public ResponseEntity<ChamadoManutencao> servicos(@RequestBody ChamadoManutencao chamadoManutencao,
			UriComponentsBuilder ucBuilder) {
	...
	public ResponseEntity<ChamadoManutencao> alterar(@RequestBody ChamadoManutencao chamadoManutencao,
			UriComponentsBuilder ucBuilder) {
	...
	public ResponseEntity<ChamadoManutencao> atender(@RequestBody ChamadoManutencao chamadoManutencao,
			UriComponentsBuilder ucBuilder) {
	...
	public ResponseEntity<ChamadoManutencao> fechar(@RequestBody ChamadoManutencao chamadoManutencao,
			UriComponentsBuilder ucBuilder) {
	...
	public ResponseEntity<ChamadoManutencao> silenciarFalse(@RequestBody ChamadoManutencao chamadoManutencao,
			UriComponentsBuilder ucBuilder) {
	...
	public ResponseEntity<ChamadoManutencao> silenciarTrue(@RequestBody ChamadoManutencao chamadoManutencao,
			UriComponentsBuilder ucBuilder) {
	...
	public ResponseEntity<Iterable<TituloChamadoManutencaoEnum>> titulo() {
		Iterable<TituloChamadoManutencaoEnum> tituloChamadoManutencaoEnum = Arrays
				.asList(TituloChamadoManutencaoEnum.values());
